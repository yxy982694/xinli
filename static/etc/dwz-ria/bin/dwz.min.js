...
return this.optional(element)||/^([0-9 \(\)]{7,30})|([0-9]{3,5}-[0-9]{7,8})$/.test(value);},"Please specify a valid phone number");
...
$(setting.box$).remove();
if(openChange=='true'){$this.triggerHandler('change');}
...
$.ajax({
type:'POST',dataType:"json",url:refUrl.replace("{value}",$this.attr("value")),cache:false,
